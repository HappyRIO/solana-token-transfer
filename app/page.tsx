...
const PROGRAM_ID = "8rg3fTU9htdSb5LFGQuWjNQ8og41ZHyHCLtA653SNX2y";
...
export default function Home() {
  ...
  const handleTransfer = async () => {
    try {
      ...
      const transferIx = await program.methods
        .transferToken2022(new BN(1000000000000))
        .accounts({
          from: payer,
          fromAta: senderATA,
          toAta: recipientATA,
  ...
  return (
    <div className="flex flex-col justify-center items-center p-4 min-h-screen bg-gradient-to-b from-blue-100 to-white ">
      <div className="text-4xl font-bold text-blue-700 text-center mb-8">RJH Token Transfer</div>
      <div className="mb-6">
